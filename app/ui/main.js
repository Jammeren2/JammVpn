...
const RELEASE_NOTES = [
  "Исправлен «зомби»-перехват: при смене драйвера/перезапуске старый перехват не закрывался и ломал split (Discord не во все каналы, WinpkFilter не работал).",
  "Выше скорость загрузки через VPN (увеличено TCP-окно netstack).",
  "Раздельный туннель: UDP выбранных приложений (голос в Discord) теперь работает.",
  "Раздельный туннель надёжнее на ПК с несколькими сетевыми адаптерами (оба драйвера).",
  "Подписки: ноды объединяются по балансировщикам, кнопка «★ лучший» выбирает быстрейшую.",
  "Узлы: исправлен выбор при одинаковых именах; страна по флаг-эмодзи в подписи.",
  "Статистика: виден процесс-инициатор соединения и UDP-трафик.",
