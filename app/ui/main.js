...
const RELEASE_NOTES = [
  "Новый протокол Hysteria2 — TCP и UDP, с копированием ссылки.",
  "Правила маршрутизации всегда в приоритете и применяются без перезапуска VPN.",
  "Раздельный туннель (WinDivert): авто-восстановление при сбое драйвера.",
  "Уведомления в окне: недоступность узла (с откатом) и сбой драйвера.",
  "Тест задержек не ошибается на 403/5xx; новое универсальное добавление узла.",
];
