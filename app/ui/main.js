...
const RELEASE_NOTES = [
  "Новый протокол Hysteria2 — TCP и UDP (QUIC + HTTP/3), с копированием ссылки.",
  "Тест задержек: узлы, отдающие 403/5xx, больше не помечаются «ошибкой».",
  "Добавление узла: одно универсальное поле + подсказки по протоколам.",
