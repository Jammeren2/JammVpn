...
pub struct Settings {
    ...
    /// Локальный адрес прокси (SOCKS5/HTTP), напр. `127.0.0.1:1080`.
    pub listen: Option<String>,
    /// Выбранный на «Главной» узел: весь трафик идёт через него (`None` — по
    /// правилам конфига). Запоминается между запусками.
