// Ported from cfal/shoes `src/vless/vision_filter.rs` — MIT License, (c) 2021-2023 Alex Lau.
// Adapted for JammVPN (parse_server_hello из super::vision_tls_util). См. ATTRIBUTION.md.
use super::vision_tls_util::parse_server_hello;
